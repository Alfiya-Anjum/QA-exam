...
def hover_profile(driver, index):
...
class ChromeSearch(unittest.TestCase):
    ...
    def test_if_right_page(self):
        ...
        driver.save_screenshot("testscreenshots\screenshot.png")
        self.assertEqual("https://the-internet.herokuapp.com/hovers", 
                         driver.current_url)
    ...
    def test_if_hover_shows_informations(self):
        ...
        time.sleep(2)
        for i in range(1, 4):
            link_username = hover_profile(driver,i)  
    ...
    def test_if_viewprofile_link_works(self):
        ...
        for i in range(1, profiles):
            ...
            time.sleep(1)
            driver.save_screenshot("testscreenshot2.png")
